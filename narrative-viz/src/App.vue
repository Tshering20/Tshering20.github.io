...
export default {
  ...
  data: () => ({
    dialog: true,
    dialogText: ["The dataset used contains a list of video games with sales greater than 100,000 copies obtained from vgchartz.com.", "I have examined a subset of this data to the 100 best selling games according to the decades from the 80s onward", "I want to display the differences in game sales according to the representation of different publishers, genres, and platforms for the most popular games"],
